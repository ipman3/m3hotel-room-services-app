...
import { confirmAppointmentSchema, type ConfirmAppointmentInput } from "@/validations/confirmAppointment";
          ...
          {filteredItems.map((item) => (
            <div key={item.id} className="flex items-center justify-between gap-2 pb-3 text-sm border-b border-gray-100 last:border-0 last:pb-0">
              ...
              <div className="flex flex-col justify-between flex-grow">
                ...
                <div className="flex">
                  <span className="text-base font-semibold text-base-primary">Price: ${parseFloat(item.price).toFixed(2)}</span>
                </div>
              </div>
            </div>
          ))}
