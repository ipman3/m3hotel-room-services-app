...
export default function MainPage() {
    ...
    const onSubmit = (data: CustomerFormData) => {
        ...
        const serviceType = displayedItems.length > 0 ? displayedItems[0].serviceType === "wellness-spa" ? 'spa' : displayedItems[0].serviceType : 'restaurant';
    ...
    return (
        <div className="px-4 py-8 space-y-6">
                            ...
                            <FormField
                                ...
                                render={({field}) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input readOnly placeholder="Enter room number"
                                                   className="w-full py-5" {...field} />
                                        </FormControl>
                                        <FormMessage/>
                                    </FormItem>
                                )}
                    ...
                    return (
                        <div
                            ...
                            <div className="flex-grow">
                                ...
                                <>
                                    <p className="text-xs text-muted-foreground">Unit Price:
                                        ${parseFloat(currentItem.price).toFixed(2)}</p>
                                    <p className="text-xs font-semibold text-base-secondary">Quantity: x{quantity}</p>
                                    <p className="mt-1 text-sm font-semibold text-base-secondary">Total:
                                        ${(parseFloat(currentItem.price) * quantity).toFixed(2)}</p>
                                </>
                            </div>
                            <Button
            ...
            <CustomButtonSubmit textBtn="Confirm" isLoading={form.formState.isSubmitting}
            ...
            <AlertDialog open={isClearDialogOpen} onOpenChange={setIsClearDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>This action cannot be undone. This will permanently remove all items
                            from your cart.</AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
