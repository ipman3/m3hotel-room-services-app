              ...
              {filteredItems?.map((item:any) => (
                <div
                  ...
                  <div>
                    ...
                    <img src={item.imageUrl} alt={item.name} className="flex-shrink-0 object-cover rounded-lg w-22 h-22" />
                  </div>
                  ...
                  <div className="flex-1 mb-2">
                    <div className="flex items-start justify-between">
                      <div>
                        <div className="text-base font-semibold text-base-secondary">{item.name}</div>
