...
export default function PlaceOrderPage() {
  ...
  const {
    ...
    removeItem,
    confirmPendingItem,
    clearCartByServiceType,
  } = useCartStore();
  const [isConfirmOpen, setIsConfirmOpen] = useState(false);

  const filteredItems = items.filter(
    (item) => item.serviceType === "room-service"
  );
              ...
              {filteredItems?.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 mb-2">
                    ...
                    <div className="text-base font-bold text-base-secondary">
      ...
      <AlertDialog open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to place this order? Your card will be
              charged a total of <strong>${total.toFixed(2)}</strong>.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
